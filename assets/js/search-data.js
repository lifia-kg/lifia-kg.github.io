...
ninja.data = [{
    id: "nav-observatorio-inmobiliario",
    title: "Observatorio Inmobiliario",
    section: "Navigation",
    handler: () => {
      window.location.href = "/";
    },
  },{id: "nav-acontecimientos",
          title: "Acontecimientos",
          description: "Aca poner, los papers publicados (?). Esta la tesis de Lu, el paper de grafo de conocimiento(?), etc..",
          section: "Navigation",
          handler: () => {
